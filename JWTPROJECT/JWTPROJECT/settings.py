...
SECRET_KEY = "django-insecure-fboo%kkpb6z*^1f(xf_@v&s%lda+u-5vm_3t=c@q)*g8f4jm-q"
...
# EMAIL_HOST_USER = 'studytapdevloper@gmail.com'
# EMAIL_HOST_PASSWORD = 'uapgbhrrwmykewte'
# EMAIL_USE_TLS = True
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "studytapdevloper@gmail.com"#sender's email-id
EMAIL_HOST_PASSWORD = "uaktuyscdtpnbaqm"#password associated with above email-id
